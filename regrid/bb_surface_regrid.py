...
def main():
    ...
    #####################################
    # source grid
    CAMS_grid_file = "grids/ceds_surface_emission_grid.nc"      # source grid

    add_bounds_to_source_file = False
    CAMS_grid_file_with_bnds = "grids/bounds_ceds.nc"  # source grid with bounds
    ...
    Regridding_weights_file =  "grids/bb_ESMF_Weight_0.5x0.5_to_ne30.nc"

    # outputs
    path_out = "/glade/derecho/scratch/gaubert/cmip_outputs_2025/ne30/bb/"
